...
DO:
    ...
    DO:
        ...
        OUTPUT TO VALUE("E:\ICS_Udugama\bin\print\TransactionReport.txt").
...
/*             PUT UNFORMAT "||Value|" + STRING(filValue)SKIP. */
        ...
        DOS SILENT START VALUE("E:\ICS_Udugama\bin\print\TransactionReport.bat").
        DOS SILENT START excel VALUE("E:\ICS_Udugama\bin\print\TransactionReport.xlsx").
    END.
