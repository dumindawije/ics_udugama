...
DO:
    ...
    IF yn = YES THEN
    DO:
        OUTPUT TO VALUE("E:\ICS_Udugama\bin\print\Collection_Report.txt"). 
        ...
        OUTPUT TO VALUE("E:\ICS_Udugama\bin\print\CollectionChart.txt").

        PUT UNFORMAT STRING(chartString).

        OUTPUT CLOSE.

        DOS SILENT START VALUE("E:\ICS_Udugama\bin\print\CollectionReport.bat").       
        DOS SILENT START excel VALUE("E:\ICS_Udugama\bin\print\CollectionReport.xlsx").
